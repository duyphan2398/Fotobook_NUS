...
ActiveRecord::Schema.define(version: 2019_07_18_090807) do
  ...
  create_table "pics", options: "ENGINE=InnoDB DEFAULT CHARSET=latin1", force: :cascade do |t|
    t.string "title"
    t.text "description"
    ...
    t.bigint "image_file_size"
    t.datetime "image_updated_at"
    t.index ["imageable_type", "imageable_id"], name: "index_pics_on_imageable_type_and_imageable_id"
  end
